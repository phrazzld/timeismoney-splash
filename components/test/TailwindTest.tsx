  ...
  return (
    <div className="space-y-4 p-4">
      ...
      <div className="flex flex-wrap gap-2">
        <span className="px-2 py-1 text-xs bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-100 rounded-full">Tag 1</span>
        <span className="px-2 py-1 text-xs bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-100 rounded-full">Tag 2</span>
        <span className="px-2 py-1 text-xs bg-red-100 text-red-800 dark:bg-red-950 dark:text-red-100 rounded-full">Tag 3</span>
      </div>
    </div>
  );
};
