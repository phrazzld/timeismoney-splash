...
describe('Structured Logger (T018)', () => {
  ...
  describe('Error Sanitization', () => {
    ...
    it('should handle React error boundaries with component stack', () => {
      const error = new Error('Component error') as unknown;
    ...
    it('should handle non-Error objects', () => {
      ...
      const sanitized = sanitizeError(nonError as unknown);
    ...
    it('should handle null and undefined errors', () => {
      const nullSanitized = sanitizeError(null as unknown);
      const undefinedSanitized = sanitizeError(undefined as unknown);
  ...
  describe('Performance and Memory Management', () => {
    ...
    it('should respect maximum entries limit', () => {
      ...
      const entries = (limitedLogger as unknown).getEntries();
  ...
  describe('Error Handling and Edge Cases', () => {
    ...
    it('should handle null and undefined messages', () => {
      expect(() => logger.info(null as unknown)).not.toThrow();
      expect(() => logger.info(undefined as unknown)).not.toThrow();
